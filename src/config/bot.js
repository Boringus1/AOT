...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        name: "Extracting oil", // required by Discord API, not shown in the client
        state: "Extracting oil",     // this is what people actually see
        type: 4,               // Custom
      },
    ],
  },
  ...
  welcome: {
    ...
    defaultWelcomeMessage:
      "Welcome comrade {user} to {server}! We now have {memberCount} members!",
